...
var Rocket = preload("res://resource/src/Scenes/Rocket.tscn")
var Bullet = preload("res://resource/src/Scenes/Bullet.tscn")
var BulletEnemy = preload("res://resource/src/Example_Game/Bullet_Enemy.tscn")
